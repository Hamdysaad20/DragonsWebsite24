...
const Card = ({ isPremier, title, description, overlayStyle, label, isDisabled }) => (
    ...
    >
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-50" style={{ background: overlayStyle }} />
    </Link>
);
    ...
    return (
        <div className="w-full flex flex-col gap-8 text-white">
            <div className="head container mx-auto flex flex-col gap-7 justify-center text-center max-w-[800px] pt-5">
                ...
                <p className="text-white/50 text-lg md:text-base">{HeadData.description}</p>
            </div>
