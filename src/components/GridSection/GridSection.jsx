...
function GridSection() {
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center gap-8 text-white">
            ...
            <Link href={BOOTCAMP_URL} className="border-2 w-fit text-2xl rounded-full py-1 px-3 inline-block hover:bg-purple-900 hover:text-white transition-all hover:border-purple-900 mt-5">{'Learn More'}</Link>
        </div >
    );
}
