...
function TestmonialSection() {
    ...
    const Description = {
        ...
        text2: "Their developers go beyond just implementing tasks; they take full ownership, consistently deliver outcomes, and",
                ...
                <div className="content z-[20] absolute flex flex-col gap-6 max-w-[600px]">
                    ...
                    <div className="info flex justify-center items-center md:mt-4 gap-1 flex-col">
                        <div className="image rounded-full flex justify-center items-center p-1  ring-1">
                            <Image src={Info.image} alt="logo" width="80" height="80" className=" rounded-full" />
                        </div>
                        <div className="items text-center">
                            <h3 className=" text-2xl">{Info.name}</h3>
                            <p className=" text-[14px] md:text-xl text-white/60">{Info.designation}</p>
                        </div>
                    </div>
                </div>
                <div className="grediant-background rounded-b-[85px] bg-gradient-to-r from-[#236c8c] to-[#a3127e]  w-[calc(100%-80px)] z-[2] h-[calc(100%-40px)] absolute   "> </div>
                <div className="colored-background shadow-[inset_0px_0px_10px_2px_rgba(255,255,255,0.2)] mx-auto  bg-gradient-to-r from-[#2c2d7c] to-[#18113f] rounded-b-[120px]  w-full z-[1] h-full absolute "> </div>
            </div>
        </div>
    )
}
